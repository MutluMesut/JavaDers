...
public class C08_NestedForLoop {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <=4 ; i++) {     // outer loop denir ve i'nin carpilacagi sayiyi kontrol edecek.Ayrıca satirda islemi
                                            //kac kez tekrar edecegimizi belirleriz

            for (int j = 1; j <=4 ; j++) {  // inner loop denir ve onceki ornekteki i degiskenini kontrol eder
                                            //ayrıca satiri nasil yazdiracağimizi belirler
